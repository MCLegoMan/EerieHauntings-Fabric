...
public class SoulBall extends Item {
    ...
    public void appendHoverText(ItemStack p_41421_, @Nullable Level p_41422_, List<Component> p_41423_, TooltipFlag p_41424_) {
        ...
        //todo: EerieHauntings.serverConfig.SOULBALLCHANCEADD.get().floatValue()
        p_41423_.add(new TranslatableComponent("soulball.eeriehauntings.info", 5).withStyle(ChatFormatting.BLUE));
