...
//            });
    ...
    public void appendHoverText(ItemStack p_41421_, @Nullable Level p_41422_, List<Component> p_41423_, TooltipFlag p_41424_) {
        ...
        //todo: EerieHauntings.serverConfig.CHALKDURATION.get()
        p_41423_.add(new TranslatableComponent("info.eeriehauntings.calciteexplain", 10).withStyle(ChatFormatting.GOLD));
    }
}
