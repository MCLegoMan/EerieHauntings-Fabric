    ...
    public void appendHoverText(ItemStack p_41421_, @Nullable Level p_41422_, List<Component> p_41423_, TooltipFlag p_41424_) {
        if(p_41422_ != null && p_41422_.isClientSide) {
            if (!ClientInitializer.easyModeEnabled) {
                p_41423_.add(Component.translatable("tools.eeriehauntings.water").withStyle(ChatFormatting.GOLD));
            } else {
                p_41423_.add(Component.translatable("tools.eeriehauntings.easywater").withStyle(ChatFormatting.GOLD));
            }
        }
