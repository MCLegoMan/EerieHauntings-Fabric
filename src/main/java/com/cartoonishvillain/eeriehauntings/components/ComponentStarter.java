...
public class ComponentStarter implements EntityComponentInitializer, WorldComponentInitializer {
    ...
    public static final ComponentKey<WorldComponent> WORLDCOMPONENTINSTANCE =
            ComponentRegistryV3.INSTANCE.getOrCreate(new ResourceLocation("eeriehauntings:worldtracker"), WorldComponent.class);
    @Override
    ...
    public void registerWorldComponentFactories(WorldComponentFactoryRegistry registry) {
        registry.register(WORLDCOMPONENTINSTANCE, world -> new WorldComponent());
    }
