package com.cartoonishvillain.eeriehauntings.packets.spawning;
...
public class EntitySpawnPacket {
    public static Packet<?> create(Entity e, ResourceLocation packetID) {
        ...
        PacketBufUtil.writeVec3(byteBuf, e.position());
    ...
    public static final class PacketBufUtil {
         ...
         *         vector
         */
        public static void writeVec3(FriendlyByteBuf byteBuf, Vec3 vec3d) {
